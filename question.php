		  ...
		  <div class="column side">
  			 ...
  			 <ul>
			    <b> <li><a href="adminprof.php">My Profile</a></li>
			        <li><a class="active" href="question.php">Latest Questions</a></li>
 		  ...
 		  <div class="column middle">
				...
				<label for="datemin">Enter the starting date for Questions Asked:</label>
...
if(isset($_POST['datemin']))
{
   //$sql = "SELECT * FROM admin WHERE dateAsked>= '2021-04-15' ";
   $date = $_POST["datemin"];
   $sql = "SELECT * FROM admin WHERE dateAsked>= '$date' ";
